<template>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card">
                    <img :src="items[0].image" alt="Hình ảnh" width="320px" height="200px" />
                    <div class="card-body">
            ...
            <div class="col-sm-4">
                <div class="card">
                    <img :src="items[1].image" alt="Hình ảnh" width="320px" height="200px" />
                    <div class="card-body">
            ...
            <div class="col-sm-4">
                <div class="card">
                    <img :src="items[2].image" alt="Hình ảnh"width="320px" height="200px"  />
                    <div class="card-body">
